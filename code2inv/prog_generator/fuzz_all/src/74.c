...
void precheck(FILE* fptr, char* buff, long long int c, long long int x1, long long int x2,
...
void loopcheck(FILE* fptr, char* buff, long long int temp_c, long long int temp_y,
