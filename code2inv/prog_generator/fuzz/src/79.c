...
// variable declarations
    ...
    FILE* inputs = fopen("inputs/inputs_79.txt", "a");
    ...
    for (;;) {
        ...
        long long int choices = honggBuf[23];

#ifndef READ_FROM_FLAG
        long long int i = honggBuf[15];
        long long int x = honggBuf[56];
        long long int y = honggBuf[69];
#endif
