...
// variable declarations
    ...
    for (;;) {
        ...
        long long int choices = honggBuf[99];

#ifndef READ_FROM_FLAG
        long long int i = honggBuf[45];
        long long int size = honggBuf[56];
        long long int sn = honggBuf[85];
        long long int v1 = honggBuf[20];
        long long int v2 = honggBuf[39];
        long long int v3 = honggBuf[73];
#endif
