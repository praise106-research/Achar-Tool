...
from code2inv.prog_generator.checkers.c_inv_checker_all import inv_checker as z3_inv_checker
...
filepath = os.path.join(pwd, os.pardir, f"fuzz_all/include/{example}.h")
fuzzbase = os.path.join(pwd, os.pardir, f"fuzz_all")
...
def inv_solver(vc_file: str, inv: str):
    ...
    tqdm.write(f"[Hybrid Checker (All)] {inv}")
    ...
    if all(x is None for x in z3_res):
        ...
        tqdm.write("[Hybrid Checker (All)] Z3 is UNSAT, Calling fuzzer \n")
