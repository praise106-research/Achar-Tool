...
filepath = os.path.join(pwd, os.pardir, f"NN_Example/include/{example}.h")
fuzzbase = os.path.join(pwd, os.pardir, f"NN_Example")
...
def dump_template(file, inv_code):
    with open(file, mode="w") as fileptr:
        fileptr.write(f"#define OUTPLACE 1 // generated by code2inv\n")
...
def inv_solver(vc_file: str, inv: str):
    ...
    tqdm.write(f"[RQ3 NN Solver] {inv}")
