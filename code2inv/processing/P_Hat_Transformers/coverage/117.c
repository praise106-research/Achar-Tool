...
int main(int argc, char** argv) {
    ...
    // Translate()
    if (choices > 10000) {
        prebody_f1(choices, sn, v1, v2, v3, x);
        ...
        if ((choices > 2500)) {
            ...
            while ((choices > 2500) && unroll--) {
                ...
                loopbody_f2(choices, sn, v1, v2, v3, x);

                loopcount++;
                loopcheck(fptr, vars, temp_sn, temp_v1, temp_v2, temp_v3, temp_x, sn, v1, v2, v3,
                          x);
            }
        } else {
            // post-check program
            ...
            // post-condition
            if ((sn != -1)) {
                postcheck(fptr, vars, ((sn == x)), sn, v1, v2, v3, x)
            }
        }
    }
