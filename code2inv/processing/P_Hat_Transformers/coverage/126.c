...
int main(int argc, char** argv) {
    ...
    long long int z1 = atoi(argv[5]);
    long long int z2 = atoi(argv[6]);
    long long int z3 = atoi(argv[7]);
    ...
    snprintf(vars, 128,
             ...
             i, "j", j, "x", x, "y", y, "z1", z1, "z2", z2, "z3", z3);

    // Translate()
    if (choices > 10000) {
        prebody_f1(choices, i, j, x, y, z1, z2, z3);
        ...
        if ((x != 0)) {
            ...
            while ((x != 0) && unroll--) {
                ...
                loopbody_f2(choices, i, j, x, y, z1, z2, z3);

                loopcount++;
                loopcheck(fptr, vars, temp_i, temp_j, temp_x, temp_y, temp_z1, temp_z2, temp_z3, i,
                          j, x, y, z1, z2, z3);
            }
        } else {
            // post-check program
            ...
            // post-condition
            if ((i == j)) {
                postcheck(fptr, vars, ((y == 0)), i, j, x, y, z1, z2, z3)
            }
        }
    }
