...
// variable declarations
    ...
    FILE* inputs = fopen("inputs/inputs_82.txt", "a");
        ...
        if (choices > 10000) {
            ...
            if ((choices > 2500)) {
                ...
                while ((choices > 2500) && unroll--) {
                    ...
                    loopcount++;
                    loopcheck(fptr, vars, temp_z1, temp_z2, temp_z3, temp_i, temp_x, temp_y, z1, z2,
                              z3, i, x, y);
                }
            } else {
                // post-check program
                ...
                if ((i >= x)) {
                    if ((0 > i)) {
                        postcheck(fptr, vars, ((i >= y)), z1, z2, z3, i, x, y)
                    }
                }
            }
        }
