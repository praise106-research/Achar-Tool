/**
 * Contains a class to assist with the calculation of dominance frontiers, including local and up
 * dominance as well as a function to calculate the location of phi nodes as per Ron Cytron et al.
 */
