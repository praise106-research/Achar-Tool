...
( declare-const __multiply_arg1_res_1 Int )
( declare-const __multiply_arg1_res_2 Int )
...
( define-fun inv-f( ( __multiply_arg1_res Int )( k Int )( n Int )( res Int ) ) Bool
...
( define-fun trans-f ( ( __multiply_arg1_res Int )( k Int )( n Int )( res Int )( __multiply_arg1_res! Int )( k! Int )( n! Int )( res! Int )( __multiply_arg1_res_0 Int )( __multiply_arg1_res_1 Int )( __multiply_arg1_res_2 Int )( k_0 Int )( k_1 Int )( k_2 Int )( k_3 Int )( n_0 Int )( res_0 Int )( res_1 Int )( res_2 Int )( res_3 Int ) ) Bool
	( or
		( and
...
( assert ( not
	( =>
		( pre-f __multiply_arg1_res k n res __multiply_arg1_res_0 __multiply_arg1_res_1 __multiply_arg1_res_2 k_0 k_1 k_2 k_3 n_0 res_0 res_1 res_2 res_3  )
		( inv-f __multiply_arg1_res k n res )
	)
))
...
( assert ( not
	( =>
		( and
			( inv-f __multiply_arg1_res k n res )
			( trans-f __multiply_arg1_res k n res __multiply_arg1_res! k! n! res! __multiply_arg1_res_0 __multiply_arg1_res_1 __multiply_arg1_res_2 k_0 k_1 k_2 k_3 n_0 res_0 res_1 res_2 res_3 )
		)
		( inv-f __multiply_arg1_res! k! n! res! )
	)
))
...
( assert ( not
	( =>
		( inv-f __multiply_arg1_res k n res  )
		( post-f __multiply_arg1_res k n res __multiply_arg1_res_0 __multiply_arg1_res_1 __multiply_arg1_res_2 k_0 k_1 k_2 k_3 n_0 res_0 res_1 res_2 res_3 )
	)
))
